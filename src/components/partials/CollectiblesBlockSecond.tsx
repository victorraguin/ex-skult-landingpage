...
const CollectiblesBlockSecond = () => {
  ...
  return (
    <motion.div
      ...
      ref={ref}
    >
      <motion.div className="mx-auto flex flex-col flex-wrap justify-around gap-y-8 sm:flex-nowrap md:flex-row xl:w-8/12 2xl:w-6/12 4xl:w-1/2">
        <motion.div className="flex flex-1 flex-col" variants={CardItem}>
          ...
          <p className="mx-auto w-[90%] pt-4 text-center font-poppins text-[18px] font-medium text-[#b8b8b8] 4xl:w-3/4">
