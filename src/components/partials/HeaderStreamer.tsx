    ...
    <div className="fixed z-50">
      ...
      >
        <Link href="/#Streamer-Anybody" passHref>
          <motion.button
            className={`${styles.HeaderJoinDiscord} bottom-0 left-10  scale-[0.7] rounded-full bg-gradient-to-br from-[#FFCC00] to-[#ED713C] p-0.5 hover:scale-[1] sm:scale-[0.9]`}
          >
      ...
      <div className="z-2 absolute inset-0">
        <motion.div initial={{ y: -250 }} animate={{ y: -10 }} transition={{ type: 'spring', stiffness: 40 }}>
          <img
            className=" mx-auto mt-6 h-8 md:mx-auto  md:mt-5 xl:mx-auto xl:mt-7 xl:h-12 2xl:h-14 4xl:h-16"
