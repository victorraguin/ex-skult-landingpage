...
const SocialBlock = () => {
  ...
  const discord = {
    visible: { translateY: 7, transition: { delay: 0.5, duration: 0.7, yoyo: Number.POSITIVE_INFINITY } },
    hidden: { opacity: 0 },
  };

  const ombre = {
    visible: { scale: [1, 0.95], transition: { delay: 0.5, duration: 0.7, yoyo: Number.POSITIVE_INFINITY } },
    hidden: { opacity: 0 },
  };
  ...
  return (
    <motion.div className={`h-screen flex-auto xl:h-screen`} ref={ref}>
      <motion.div
        style={{
