          ...
          <Link href="/streamer" passHref>
            <motion.button
              className={`
                ...
                md:right-[0rem] md:scale-[0.7] md:group-hover:scale-[0.75]
                xl:top-[-3rem] xl:right-20 xl:scale-[0.8] xl:group-hover:scale-[0.85]
                2xl:scale-[0.9] 2xl:group-hover:scale-[0.95]
                3xl:scale-[0.95] 3xl:group-hover:scale-[1]
                4xl:scale-[1] 4xl:group-hover:scale-[1.05]
              `}
            >
